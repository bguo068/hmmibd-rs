...
This folder contains hmmIBD C code based on https://github.com/glipsnort/hmmIBD/ @commit a2f796ef8122d7f6b983ae9ac4c6fba35afcd3aa. The code is largely a clone of the original but includes a few changes:
- Added command line option to set the recombination rate
- Formatted the C code with clangd.
